...
from evaluation import merck_r_square, pearson_r_square, calculate_SSA
import torch
...
def test_model(folder, visual, savePoints):	
	...
	#calculate r square 
	train_r2 = merck_r_square(train_pred, train_label)
	val_r2 = merck_r_square(val_pred, val_label)
...
if __name__ == "__main__":
	print(test_model("bace/", True, [40, 45, 50]))
